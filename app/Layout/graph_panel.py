...
def load(parent):
    ...
    y_zoom_in.image = Tk.PhotoImage(file=os.path.join(config.DIR, 'img','y_zoom_in.png'), master=pymini.root)
    ...
    y_zoom_out.image = Tk.PhotoImage(file=os.path.join(config.DIR, 'img', 'y_zoom_out.png'), master=pymini.root)
    ...
    pan_up.image = ImageTk.PhotoImage(arrow, master=pymini.root)
    ...
    pan_down.image = ImageTk.PhotoImage(arrow.rotate(180), master=pymini.root)
    ...
    x_zoom_in.image = Tk.PhotoImage(file=os.path.join(config.DIR, 'img', 'x_zoom_in.png'), master=pymini.root)
    ...
    x_zoom_out.image = Tk.PhotoImage(file=os.path.join(config.DIR, 'img', 'x_zoom_out.png'), master=pymini.root)
    ...
    pan_left.image = ImageTk.PhotoImage(arrow.rotate(90), master=pymini.root)
    ...
    pan_right.image = ImageTk.PhotoImage(arrow.rotate(270), master=pymini.root)
