...
This section introduces the basic steps for various workflows
supported by SimplyFire.

Detailed description of each plugin can be found in the :doc:`plugins_gui` section.
