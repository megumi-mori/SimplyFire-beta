...
def filter_mini(
        ...
        direction=1,
        peak_idx=None,
        lag=config.detector_core_lag,
        min_amp=config.detector_filter_min_amp,
        min_rise=config.detector_filter_min_rise,
        max_rise=config.detector_filter_max_rise,
        min_hw=config.detector_filter_min_hw,
        max_hw=config.detector_filter_max_hw,
        min_decay=config.detector_filter_min_decay,
        max_decay=config.detector_filter_max_decay,
        max_points_decay=config.detector_core_max_points_decay,
        df=None,
        x_sigdig=None
):
    data = {}
