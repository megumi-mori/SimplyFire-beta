...
def load(parent):
    ...
    y_zoom_in.image = Tk.PhotoImage(file=os.path.join(IMG_DIR,'y_zoom_in.png'), master=app.root)
    ...
    y_zoom_out.image = Tk.PhotoImage(file=os.path.join(IMG_DIR, 'y_zoom_out.png'), master=app.root)
    ...
    pan_up.image = ImageTk.PhotoImage(arrow, master=app.root)
    ...
    pan_down.image = ImageTk.PhotoImage(arrow.rotate(180), master=app.root)
    ...
    x_zoom_in.image = Tk.PhotoImage(file=os.path.join(IMG_DIR, 'x_zoom_in.png'), master=app.root)
    ...
    x_zoom_out.image = Tk.PhotoImage(file=os.path.join(IMG_DIR, 'x_zoom_out.png'), master=app.root)
    ...
    pan_left.image = ImageTk.PhotoImage(arrow.rotate(90), master=app.root)
    ...
    pan_right.image = ImageTk.PhotoImage(arrow.rotate(270), master=app.root)
